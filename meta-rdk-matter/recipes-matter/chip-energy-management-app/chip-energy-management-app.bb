PN = "chip-energy-management-app"
SUMMARY = "Matter Chip Energy Management App CLI"
LICENSE = "Apache-2.0"
...
SRC_URI += "file://chip-energy-management-app.service"
...
SYSTEMD_SERVICE:${PN} = "chip-energy-management-app.service"
SYSTEMD_AUTO_ENABLE:${PN} = "disable"

APP_PATH = "examples/energy-management-app/linux"
APP_BINARY = "chip-energy-management-app"
...
do_install() {
    ...
    install -m 644 ${WORKDIR}/chip-energy-management-app.service ${D}/lib/systemd/system/
}
