PN = "chip-bridge-app"
SUMMARY = "Matter Chip Bridge App CLI"
LICENSE = "Apache-2.0"
...
SRC_URI += "file://chip-bridge-app.service"
...
SYSTEMD_SERVICE:${PN} = "chip-bridge-app.service"
SYSTEMD_AUTO_ENABLE:${PN} = "disable"

APP_PATH = "examples/bridge-app/linux"
APP_BINARY = "chip-bridge-app"
...
do_install() {
    ...
    install -m 644 ${WORKDIR}/chip-bridge-app.service ${D}/lib/systemd/system/
}
