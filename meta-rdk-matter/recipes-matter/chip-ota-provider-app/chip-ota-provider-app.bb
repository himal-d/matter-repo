PN = "chip-ota-provider-app"
SUMMARY = "Matter Chip Ota Provider App CLI"
LICENSE = "Apache-2.0"
...
SRC_URI += "file://chip-ota-provider-app.service"
...
SYSTEMD_SERVICE:${PN} = "chip-ota-provider-app.service"
SYSTEMD_AUTO_ENABLE:${PN} = "disable"

APP_PATH = "examples/ota-provider-app/linux"
APP_BINARY = "chip-ota-provider-app"
...
do_install() {
    ...
    install -m 644 ${WORKDIR}/chip-ota-provider-app.service ${D}/lib/systemd/system/
}
