PN = "chip-ota-requestor-app"
SUMMARY = "Matter Chip Ota Requestor App CLI"
LICENSE = "Apache-2.0"
...
SRC_URI += "file://chip-ota-requestor-app.service"
...
SYSTEMD_SERVICE:${PN} = "chip-ota-requestor-app.service"
SYSTEMD_AUTO_ENABLE:${PN} = "disable"

APP_PATH = "examples/ota-requestor-app/linux"
APP_BINARY = "chip-ota-requestor-app"
...
do_install() {
    ...
    install -m 644 ${WORKDIR}/chip-ota-requestor-app.service ${D}/lib/systemd/system/
}
