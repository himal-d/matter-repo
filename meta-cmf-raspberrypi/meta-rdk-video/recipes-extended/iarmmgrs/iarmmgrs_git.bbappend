...
CFLAGS +="-DENABLE_DEEP_SLEEP -DUSE_MFR_FOR_SERIAL"
...
do_compile_append(){
    ...
    export CFLAGS="${CFLAGS} -DRDK_MFRLIB_NAME='${MFR_LIB}'"
...
do_install_append() {
    ...
    sed -i '/ExecStart=/a Restart=on-failure' ${D}${systemd_unitdir}/system/dsmgr.service
}
