...
SRC_URI_remove = "${CMF_GIT_ROOT}/rdk/devices/opensource/intel-x86-pc/emulator/sysint;module=.;protocol=${CMF_GIT_PROTOCOL};branch=${CMF_GIT_BRANCH};destsuffix=git/device;name=sysintdevice"
SRC_URI_append = " \
    ${CMF_GIT_ROOT}/rdk/devices/opensource/raspberrypi/sysint;module=.;protocol=${CMF_GIT_PROTOCOL};branch=${CMF_GIT_BRANCH};destsuffix=git/devicerpi;name=sysintdevicerpi \
"
...
do_install_append() {
	     ...
	     echo "CLOUDURL="https://xconf.rdkcentral.com:19092/xconf/swu/stb?eStbMac="" >> ${D}${sysconfdir}/include.properties
             ...
             echo ""P=https://xconf.rdkcentral.com:19092/loguploader/getSettings"" >> ${D}${sysconfdir}/include.properties

             sed -i 's/Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Telemetry.Enable=false/Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Telemetry.Enable=true/g' ${D}${sysconfdir}/rfcdefaults/sysint.ini
             sed -i 's/Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Telemetry.ConfigURL=""/Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Telemetry.ConfigURL=https:\/\/xconf.rdkcentral.com:19092\/loguploader\/getT2Settings/g' ${D}${sysconfdir}/rfcdefaults/sysint.ini
             sed -i -e '$aDevice.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Telemetry.MTLS.Enable=false' ${D}${sysconfdir}/rfcdefaults/sysint.ini
             sed -i -e '$aDevice.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.XDial.Enable=true' ${D}${sysconfdir}/rfcdefaults/sysint.ini
             sed -i -e '$aDevice.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.XDial.DynamicAppList=true' ${D}${sysconfdir}/rfcdefaults/sysint.ini
             sed -i -e '$aDevice.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.XDial.AppList=youtube:youtubetv:youtubekids' ${D}${sysconfdir}/rfcdefaults/sysint.ini
...
do_install_append_raspberrypi4() {       
             sed -i -e '$aDevice.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Dobby.WPE.Enable=true' ${D}${sysconfdir}/rfcdefaults/sysint.ini
      	     sed -i -e '$aDevice.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Dobby.Cobalt.Enable=true' ${D}${sysconfdir}/rfcdefaults/sysint.ini
             sed -i -e '$aDevice.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.AppHibernate.Enable=true' ${D}${sysconfdir}/rfcdefaults/sysint.ini
}
