...
EXTRA_OECMAKE += " \
    ...
    -DBUILD_FOR_COMMUNITY=ON \
    -DBUILD_ENABLE_DEVICE_MANUFACTURER_INFO=ON \
    "
MONITOR_PLUGIN_ARGS += " \
...
PACKAGECONFIG_append = " xcast erm deviceidentification"
PACKAGECONFIG_append = " systemservices_thermalprotection"
PACKAGECONFIG_append_hybrid = " mediaenginermf"
