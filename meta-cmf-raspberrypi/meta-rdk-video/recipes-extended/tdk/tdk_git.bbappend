...
EXTRA_OECONF_append = " --disable-storagemanager"
EXTRA_OECONF_append = " --disable-mediautils"

DEPENDS += "${@bb.utils.contains('DISTRO_FEATURES', 'tdk_standalone', ' ', ' gst-plugins-rdk ', d)}"
DEPENDS_remove = " bluetooth-mgr storagemanager "
